...
var rackHeight = 25 * 1.75; //1U size
// var rackLength = 25 * 19;  //19" is standard rack size

var elem = document.querySelector('.draggable');
var draggie = new Draggabilly(
  elem, {
    axis: 'y', // To only have it shift on the y axis
    grid: [0, rackHeight] // Make the objects move by a set amount, which I will make 1U (1.75")
  }
);
